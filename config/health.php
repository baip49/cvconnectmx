...
return [
    ...
    'system_resources' => [
        'memory' => [
            'warning_percentage' => env('HEALTH_MEMORY_WARNING_PERCENT', 80),
            'critical_percentage' => env('HEALTH_MEMORY_CRITICAL_PERCENT', 90),
        ],
        'cpu' => [
            'warning_percentage' => env('HEALTH_CPU_WARNING_PERCENT', 80),
            'critical_percentage' => env('HEALTH_CPU_CRITICAL_PERCENT', 90),
        ],
        'disk' => [
            'warning_percentage' => env('HEALTH_DISK_WARNING_PERCENT', 80),
            'critical_percentage' => env('HEALTH_DISK_CRITICAL_PERCENT', 90),
        ],
    ],
    ...
    'notifications' => [
        ...
        'notifications' => [
            HealthCheckTelegramNotification::class => ['telegram'],
        ],
